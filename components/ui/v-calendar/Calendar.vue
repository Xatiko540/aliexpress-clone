...
import type { Calendar as VCalendarInstance } from 'v-calendar'
const calendarRef = computed<InstanceType<VCalendarInstance> | null>(() => datePicker.value?.calendarRef ?? null)
